...
const Footer = () => {
  return (
    <div className="font-poppins max-width-[1240px] mx-auto py-16 px-4 lg:grid-cols-3 gap-8 text-gray-300">
      <div>
      ...
      <div className="lg:col-span-2 mx-4 flex justify-between">
        <div>
